...
const config: Config = {
  ...
  tagline: "An Instructional Book on Building Embodied AI",
  ...
  baseUrl: "/Hackathon_Physical_AI_-Humanoid_Robotics_Book/",

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: "Atiq-Developer",
  projectName: "Hackathon_Physical_AI_-Humanoid_Robotics_Book",
  onBrokenLinks: "throw",
